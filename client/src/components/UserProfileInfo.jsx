      ...
      <div className='flex flex-col md:flex-row items-start gap-6'>
        ...
        <div className='w-full pt-16 md:pt-0 md:pl-36'>
          <div className='flex flex-col md:flex-row items-start justify-between'>
            ...
            {/* if user is not on others profile that means he is opening his profile so we will give edit botton */}
            {!profileId && (
          ...
          <div className='flex flex-wrap items-center gap-x-6 gay-y-2 text-sm text-gray-500 mt-4' >
